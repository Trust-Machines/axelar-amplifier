...
pub fn messages_its_hub(its_hub_address: String, nb_messages: usize) -> Vec<Message> {
    let message = Message {
        cc_id: CrossChainId::new(
            "axelar",
            "0xff822c88807859ff226b58e24f24974a70f04b9442501ae38fd665b3c68f3834-0",
    ...
    (0..nb_messages)
        .map(|index| {
            ...
            temp_message.cc_id = CrossChainId::new(
                "axelar",
                "0xff822c88807859ff226b58e24f24974a70f04b9442501ae38fd665b3c68f3834-".to_string()
